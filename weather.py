        ...
        try:
            if send_weather:
                ...
                if channel_id:
                    promo_text = (
                        "🚕 <b>АЙДООЧУ</b>\n\n"
                        "🎁 <b><i>БЕКЕР 1 ЖЫЛДЫК акция!!!!</i></b>\n"
                        "<i>Жарыяларыңыз чектөөсүз жана унааңыздын сүрөтү менен чыгат.</i>\n\n"
                        "Кантип алса болот? Өтө жөнөкөй:\n\n"
                        "1️⃣ Төмөнкү «👑 Унаа сүрөт кошуу» баскычын басып, ботко кириңиз.\n"
                        "2️⃣ Бот сизден унааңыздын сүрөтүн сураганда — реалдуу сүрөтүңүздү жибериңиз 🚗\n"
                        "3️⃣ Даяр! Админ текшерип, сизге дароо 1 жылга бекер VIP кошуп берет ✅"
                    )
