...
async def process_and_publish_ad(text_to_analyze: str, message: types.Message, msgs_to_delete: list = None):
    ...
    - Ищет людей: "киши керек" (адам керек), "1 киши керек", "2 адам керек", "адам алам", "кетчүлөр барбы". 
    - ВАЖНОЕ ПРАВИЛО: Если написано "1 киши керек" или "2 киши керек" — это СТРОГО "айдоочу", который ищет пассажиров! Не путай с пассажиром!
    - Указывает на места: "салон бош", "орун бар", "места бар", "1 место", "алдынкы оорун".
    - Указывает свое авто (включая короткие названия): "к5", "k5", "к8", "фит", "fit", "камри", "camry", "степ", "альфард", "женил машина". Если есть марка авто — это 100% "айдоочу".

    ▶ Маркеры "жүргүнчү" (Пассажир - у него НЕТ машины):
    - Ищет авто: "такси керек", "машина керек", "минивэн керек".
    - Указывает наличие себя: "1 киши БАР", "2 адамБЫЗ", "3 киши".
    - ПРАВИЛО: Внимательно читай глагол! "1 киши БАР" — это пассажир. "1 киши КЕРЕК" — это водитель!
